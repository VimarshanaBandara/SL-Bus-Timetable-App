  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Privacy & policy',style: TextStyle(color: Colors.white,fontSize: 20.0,shadows: <Shadow>[
          Shadow(
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              SizedBox(height: 10.0,),
              Text('Cookies are files with a small amount of data that are commonly used as anonymous unique identifiers. These are sent to your browser from the websites that you visit and are stored on your devices internal memory.This Service does not use these “cookies” explicitly. However, the app may use third party code and libraries that use “cookies” to collect information and improve their services. You have the option to either accept or refuse these cookies and know when a cookie is being sent to your device. If you choose to refuse our cookies, you may not be able to use some portions of this Service.',style: TextStyle(fontSize: 18.0),),
              SizedBox(height: 10.0,),
              ...
              SizedBox(height: 10.0,),
              Text('I may update our Privacy Policy from time to time. Thus, you are advised to review this page periodically for any changes. I will notify you of any changes by posting the new Privacy Policy on this page.This policy is effective as of 2021-05-23',style: TextStyle(fontSize: 18.0),),
              SizedBox(height: 10.0,),
              ...
              RaisedButton(
                ...
                color: Colors.blue,
                onPressed: () { launch('https://docs.google.com/document/d/1yZmtQKSQvp6IDp3v5zvz7fQMVwmJ4MLlztIgg4xxxNI/edit');},
              )
