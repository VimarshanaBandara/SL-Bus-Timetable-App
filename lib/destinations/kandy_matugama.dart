...
class KandyMatugama extends StatefulWidget {
  @override
  _KandyMatugamaState createState() => _KandyMatugamaState();
}

class _KandyMatugamaState extends State<KandyMatugama> {
  @override
