...
class AnuradhapuraKandy extends StatefulWidget {
  @override
  _AnuradhapuraKandyState createState() => _AnuradhapuraKandyState();
}

class _AnuradhapuraKandyState extends State<AnuradhapuraKandy> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('135.0 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
