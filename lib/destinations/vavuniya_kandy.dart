...
class VavuniyaKandy extends StatefulWidget {
  @override
  _VavuniyaKandyState createState() => _VavuniyaKandyState();
}

class _VavuniyaKandyState extends State<VavuniyaKandy> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('5.10 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.45 AM','11.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','12.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','12.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','2.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.00 AM','3.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.40 AM','4.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','5.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.15 PM','5.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','6.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.40 PM','7.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.20 PM','7.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.10 PM','8.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.40 PM','9.15 PM'),
                        SizedBox(height: 15.0,),
