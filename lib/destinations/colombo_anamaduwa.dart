...
class ColomboAnamaduwa extends StatefulWidget {
  @override
  _ColomboAnamaduwaState createState() => _ColomboAnamaduwaState();
}

class _ColomboAnamaduwaState extends State<ColomboAnamaduwa> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Anamaduwa (AC)',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('5.20 AM','8.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 AM','9.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('12.15 PM','3.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.15 PM','4.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.15 PM','3.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','6.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','7.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 PM','8.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 PM','8.35 PM'),
                        SizedBox(height: 15.0,),
