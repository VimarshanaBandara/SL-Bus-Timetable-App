...
class ColomboJaffna extends StatefulWidget {
  @override
  _ColomboJaffnaState createState() => _ColomboJaffnaState();
}

class _ColomboJaffnaState extends State<ColomboJaffna> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('Jaffna',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('429 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('10.15 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('7.15 AM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.10 AM','8.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','12.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.35 PM','1.50 AM'),
                        SizedBox(height: 15.0,),
