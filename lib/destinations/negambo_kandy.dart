...
class NegamboKandy extends StatefulWidget {
  @override
  _NegamboKandyState createState() => _NegamboKandyState();
}

class _NegamboKandyState extends State<NegamboKandy> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('100.3 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
