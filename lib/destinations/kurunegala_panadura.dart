...
class KurunegalaPanadura extends StatefulWidget {
  @override
  _KurunegalaPanaduraState createState() => _KurunegalaPanaduraState();
}

class _KurunegalaPanaduraState extends State<KurunegalaPanadura> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Kurunagala',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('122.3 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
