                 ...
                 child: SingleChildScrollView(
                   child: Column(
                     children: [
                       ...
                       SizedBox(height: 15.0,),
                       Template('6.55 PM','10.25 PM'),
                       SizedBox(height: 15.0,),
                       Template('7.15 PM','10.45 PM'),
                       SizedBox(height: 15.0,),
                       Template('7.35 PM','11.05 PM'),
                       SizedBox(height: 15.0,),
                       Template('7.55 PM','11.25 PM'),
                       SizedBox(height: 15.0,),
                       Template('8.15 PM','11.45 PM'),
                       SizedBox(height: 15.0,),
                       Template('8.35 PM','12.05 AM'),
                       SizedBox(height: 15.0,),
                       Template('9.20 PM','12.50 AM'),
                       SizedBox(height: 15.0,),
                       Template('10.05 PM','1.35 AM'),
                       SizedBox(height: 15.0,),
                       Template('11.00 PM','2.30 AM'),
                       SizedBox(height: 15.0,),
