...
class ChilawColombo extends StatefulWidget {
  @override
  _ChilawColomboState createState() => _ChilawColomboState();
}

class _ChilawColomboState extends State<ChilawColombo> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Chilaw',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('5.00 AM','7.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.10 AM','8.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 AM','8.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','8.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 AM','8.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.50 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','8.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.10 AM','9.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.20 AM','9.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 AM','9.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.40 AM','9.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.50 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('12.00 PM','2.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.10 PM','3.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.20 PM','3.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','3.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.40 PM','3.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.50 PM','3.45PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','4.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.00 PM','5.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.15 PM','5.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.45 PM','5.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.00 PM','6.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','6.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.45 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','7.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','7.15 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('5.15 PM','8.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 PM','8.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 PM','8.45 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('8.00 PM','11.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 PM','11.15 PM'),
                        SizedBox(height: 15.0,),
