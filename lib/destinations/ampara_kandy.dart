...
class AmparaKandy extends StatefulWidget {
  @override
  _AmparaKandyState createState() => _AmparaKandyState();
}

class _AmparaKandyState extends State<AmparaKandy> {
  @override
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('5.00 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('6.40 AM','11.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.40 AM','12.40 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','7.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','8.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 PM','9.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 PM','10.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 PM','11.30 PM'),
                        SizedBox(height: 15.0,),
