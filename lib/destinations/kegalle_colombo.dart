...
class KegalleColombo extends StatefulWidget {
  @override
  _KegalleColomboState createState() => _KegalleColomboState();
}

class _KegalleColomboState extends State<KegalleColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.40 AM','6.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.50 AM','6.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 AM','6.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.10 AM','6.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.20 AM','6.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 AM','6.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.40 AM','7.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.50 AM','7.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 AM','7.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.10 AM','7.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 AM','7.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','7.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 AM','8.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.55 AM','8.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.05 AM','8.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 AM','8.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.25 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.40 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.55 AM','9.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.10 AM','9.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.25 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.40 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.55 AM','10.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.10 AM','10.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','10.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.50 AM','11.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.10 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.30 AM','11.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.50 AM','12.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.10 AM','12.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','12.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.50 AM','1.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.10 AM','1.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','1.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.50 AM','2.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.10 PM','2.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','2.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.50 PM','3.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.10 PM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','3.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','4.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.10 PM','4.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','4.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.50 PM','5.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.10 PM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','5.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.50 PM','6.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.10 PM','6.30 PM'),
