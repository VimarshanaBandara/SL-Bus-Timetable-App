...
class KuliyapitiyaColombo extends StatefulWidget {
  @override
  _KuliyapitiyaColomboState createState() => _KuliyapitiyaColomboState();
}

class _KuliyapitiyaColomboState extends State<KuliyapitiyaColombo> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Kuliyapitiya',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('කුලියාපිටිය',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('92.00 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.45 AM','5.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 AM','6.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 AM','6.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 AM','6.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 AM','6.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 AM','7.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 AM','7.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','7.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 AM','7.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','8.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 AM','8.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.20 AM','8.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.40 AM','8.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.45 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.20 AM','9.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.25 AM','9.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.40 AM','9.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.20 AM','10.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.25 AM','10.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.40 AM','10.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','11.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.30 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.45 AM','11.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','12.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.15 AM','12.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','12.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.45 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.00 AM','1.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','1.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.00 PM','2.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','2.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','3.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.15 PM','3.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.45 PM','3.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.00 PM','4.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','4.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.00 PM','5.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.10 PM','5.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','6.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 PM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 PM','7.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 PM','7.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 PM','7.30 PM'),
                        SizedBox(height: 15.0,),
