...
class VavuniyaTrincomalee extends StatefulWidget {
  @override
  _VavuniyaTrincomaleeState createState() => _VavuniyaTrincomaleeState();
}

class _VavuniyaTrincomaleeState extends State<VavuniyaTrincomalee> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('94.6 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('3.45 PM','5.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 PM','8.00 PM '),
                        SizedBox(height: 15.0,),
