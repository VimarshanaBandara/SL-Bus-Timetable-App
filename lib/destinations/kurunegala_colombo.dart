...
class KurunegalaColombo extends StatefulWidget {
  @override
  _KurunegalaColomboState createState() => _KurunegalaColomboState();
}

class _KurunegalaColomboState extends State<KurunegalaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.45 AM','8.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 AM','8.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 AM','8.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','9.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 AM','9.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.45 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','10.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 AM','10.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.35 AM','10.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','11.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','11.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.45 AM','12.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','12.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 AM','12.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.30 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.45 AM','1.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','1.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.15 AM','1.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','1.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.45 AM','2.00 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('12.00 PM','3.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.15 PM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','3.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.50 PM','4.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.05 PM','4.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.25 PM','4.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 PM','4.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.55 PM','5.10 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('3.20 PM','6.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.35 PM','6.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.50 PM','7.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.10 PM','7.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.25 PM','7.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.40 PM','7.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 PM','8.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 PM','8.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 PM','8.55 PM'),
                        SizedBox(height: 15.0,),
