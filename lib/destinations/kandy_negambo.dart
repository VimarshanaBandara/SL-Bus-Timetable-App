...
class KandyNegambo extends StatefulWidget {
  @override
  _KandyNegamboState createState() => _KandyNegamboState();
}

class _KandyNegamboState extends State<KandyNegambo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('12.40 PM','3.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','4.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.05 PM','6.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.35 PM','6.35 PM'),
                        SizedBox(height: 15.0,),
