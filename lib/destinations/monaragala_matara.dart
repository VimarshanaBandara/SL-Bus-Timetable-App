...
class MonaragalaMatara extends StatefulWidget {
  @override
  _MonaragalaMataraState createState() => _MonaragalaMataraState();
}

class _MonaragalaMataraState extends State<MonaragalaMatara> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.45 AM','8.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 AM','9.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 AM','9.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 AM','9.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','10.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','10.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 AM','11.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.20 AM','12.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.55 AM','12.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','1.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.55 AM','2.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.25 AM','3.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.15 AM','4.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.15 PM','5.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','5.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.35 PM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.15 PM','7.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','8.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','9.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 PM','10.10 PM'),
                        SizedBox(height: 15.0,),
