...
class ColomboElpitiya extends StatefulWidget {
  @override
  _ColomboElpitiyaState createState() => _ColomboElpitiyaState();
}

class _ColomboElpitiyaState extends State<ColomboElpitiya> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Elpitiya',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('ඇල්පිටිය',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('95.5 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('7.00 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','11.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','11.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.45 AM','12.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','1.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.15 AM','2.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.00 PM','2.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.45 PM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','4.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.15 PM','5.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','6.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 PM','7.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 PM','8.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 PM','9.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 PM','9.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 PM','10.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 PM','11.15 PM'),
                        SizedBox(height: 15.0,),
