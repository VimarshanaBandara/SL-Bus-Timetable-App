...
class ColomboEmbilipitiya extends StatefulWidget {
  @override
  _ColomboEmbilipitiyaState createState() => _ColomboEmbilipitiyaState();
}

class _ColomboEmbilipitiyaState extends State<ColomboEmbilipitiya> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('180.2 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('5.20 AM','10.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.20 AM','11.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.20 AM','12.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','1.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.40 AM','4.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','5.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.20 PM','6.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 PM','6.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.20 PM','7.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.50 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','9.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.20 PM','9.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.50 PM','9.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 PM','10.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.20 PM','12.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.20 PM','1.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 PM','2.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('10.10 PM','3.10 AM'),
                        SizedBox(height: 15.0,),
