...
class BadullaColombo extends StatefulWidget {
  @override
  _BadullaColomboState createState() => _BadullaColomboState();
}

class _BadullaColomboState extends State<BadullaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('12.50 AM','6.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 AM','7.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 AM','8.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.20 AM','9.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.40 AM','10.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 AM','11.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','12.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.40 AM','12.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','1.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','2.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','2.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.20 AM','2.20 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('9.40 AM','3.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','4.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','4.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.40 AM','4.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.20 AM','5.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.00 AM','6.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.40 PM','6.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.20 PM','7.20 PM'),
                        SizedBox(height: 15.0,),
