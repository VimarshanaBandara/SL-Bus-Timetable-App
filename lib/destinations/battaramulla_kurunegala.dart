...
class BattaramullaKurunegala extends StatefulWidget {
  @override
  _BattaramullaKurunegalaState createState() => _BattaramullaKurunegalaState();
}

class _BattaramullaKurunegalaState extends State<BattaramullaKurunegala> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Battaramulla',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('බත්තරමුල්ල',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('98.7 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('02.30 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.25 PM','6.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 PM','8.10 PM'),
                        SizedBox(height: 15.0,),
