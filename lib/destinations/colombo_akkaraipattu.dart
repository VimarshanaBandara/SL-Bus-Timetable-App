...
class ColomboAkkaraipattu extends StatefulWidget {
  @override
  _ColomboAkkaraipattuState createState() => _ColomboAkkaraipattuState();
}

class _ColomboAkkaraipattuState extends State<ColomboAkkaraipattu> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Akkaraipattu',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('අක්කරෙයිපත්තු',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('355.00 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.20 AM','10.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 PM','2.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 PM','3.30 AM'),
                        SizedBox(height: 15.0,),
