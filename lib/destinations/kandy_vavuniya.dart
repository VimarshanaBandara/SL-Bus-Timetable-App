...
class KandyVavuniya extends StatefulWidget {
  @override
  _KandyVavuniyaState createState() => _KandyVavuniyaState();
}

class _KandyVavuniyaState extends State<KandyVavuniya> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('180.0 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('04.35 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('5.00 AM','9.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','10.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.10 AM','11.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.10 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.10 AM','1.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.10 AM','2.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.40 AM','3.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.15 AM','3.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','5.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','5.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','6.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.10 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','8.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 PM','9.50 PM'),
                        SizedBox(height: 15.0,),
