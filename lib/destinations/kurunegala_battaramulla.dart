...
class KurunegalaBattaramulla extends StatefulWidget {
  @override
  _KurunegalaBattaramullaState createState() => _KurunegalaBattaramullaState();
}

class _KurunegalaBattaramullaState extends State<KurunegalaBattaramulla> {
  @override
