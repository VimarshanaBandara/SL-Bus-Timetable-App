...
class ColomboGalnewa extends StatefulWidget {
  @override
  _ColomboGalnewaState createState() => _ColomboGalnewaState();
}

class _ColomboGalnewaState extends State<ColomboGalnewa> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('ගල්නෑව',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                        Icon(Icons.arrow_right_alt_outlined,size: 45.0,color: Colors.white,),
                        Text('Galnewa',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('202.7 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('2.40 PM','7.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.40 PM','8.10 PM'),
                        SizedBox(height: 15.0,),
