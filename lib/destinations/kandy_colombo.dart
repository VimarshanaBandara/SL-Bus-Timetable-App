...
class KandyColombo extends StatefulWidget {
  @override
  _KandyColomboState createState() => _KandyColomboState();
}

class _KandyColomboState extends State<KandyColombo> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('116.0 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.15 AM','6.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.55 AM','7.25 AM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('7.10 PM','10.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.35 PM','11.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 PM','11.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.25 PM','12.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.50 PM','12.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.20 PM','12.50 PM'),
