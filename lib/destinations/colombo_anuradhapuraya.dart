...
class ColomboAnuradhapura extends StatefulWidget {
  @override
  _ColomboAnuradhapuraState createState() => _ColomboAnuradhapuraState();
}

class _ColomboAnuradhapuraState extends State<ColomboAnuradhapura> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('206.0 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('2.40 AM','7.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.50 AM','10.5 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.50 AM','11.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.50 AM','12.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','1.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.20 AM','2.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.05 AM','3.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.40 AM','3.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.40 AM','4.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.40 PM','5.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.10 PM','6.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','7.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.25 PM','7.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','8.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.20 PM','9.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.55 PM','10.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 PM','11.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 PM','12.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 PM','3.45 AM'),
                        SizedBox(height: 15.0,),
