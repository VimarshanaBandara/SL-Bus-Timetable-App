...
class BalangodaColombo extends StatefulWidget {
  @override
  _BalangodaColomboState createState() => _BalangodaColomboState();
}

class _BalangodaColomboState extends State<BalangodaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.20 AM','7.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.40 AM','7.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 AM','7.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 AM','8.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 AM','8.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.40 AM','8.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.50 AM','8.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 AM','9.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 AM','9.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','9.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.50 AM','10.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.10 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.25 AM','10.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','10.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 AM','11.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','11.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.20 PM','12.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.45 AM','12.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 AM','1.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','2.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.00 AM','2.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','3.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.45 AM','3.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.15 PM','4.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','4.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.00 PM','5.50 PM'),
                        SizedBox(height: 15.0,),
