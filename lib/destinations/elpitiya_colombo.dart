...
class ElpitiyaColombo extends StatefulWidget {
  @override
  _ElpitiyaColomboState createState() => _ElpitiyaColomboState();
}

class _ElpitiyaColomboState extends State<ElpitiyaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.45 AM','7.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','8.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','10.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 AM','12.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.50 AM','1.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.45 AM','2.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.30 PM','3.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.15 PM','4.0 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.00 PM','4.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.45 PM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','6.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','7.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 PM','7.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 PM','8.30 PM'),
                        SizedBox(height: 15.0,),
