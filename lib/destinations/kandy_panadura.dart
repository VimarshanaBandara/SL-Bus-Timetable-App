...
class KandyPanadura extends StatefulWidget {
  @override
  _KandyPanaduraState createState() => _KandyPanaduraState();
}

class _KandyPanaduraState extends State<KandyPanadura> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('147.3 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('04.458 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.05 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 AM','9.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.40 AM','9.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.10 AM','10.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','10.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 AM','10.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','10.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.20 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.35 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','11.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 AM','12.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','12.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','12.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.10 AM','1.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','1.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.25 AM','2.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.50 AM','2.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.10 AM','3.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','3.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.00 AM','3.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','4.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.40 AM','4.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.00 PM','4.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','5.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 PM','6.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.00 PM','6.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.20 PM','7.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.40 PM','7.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.55 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','8.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.35 PM','8.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.55 PM','8.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','8.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.10 PM','9.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 PM','9.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.05 PM','10.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.25 PM','10.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 PM','10.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 PM','11.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.45 PM','11.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 PM','12.10 PM'),
