...
class PanaduraKurunegala extends StatefulWidget {
  @override
  _PanaduraKurunegalaState createState() => _PanaduraKurunegalaState();
}

class _PanaduraKurunegalaState extends State<PanaduraKurunegala> {
  @override
