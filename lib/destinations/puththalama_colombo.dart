...
class PuttalamColombo extends StatefulWidget {
  @override
  _PuttalamColomboState createState() => _PuttalamColomboState();
}

class _PuttalamColomboState extends State<PuttalamColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.20 AM','7.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','8.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 AM','8.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.05 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.35 AM','9.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.05 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.05 AM','10.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.35 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.05 AM','11.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.35 AM','12.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.05 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.40 AM','1.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.15 AM','1.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.50 AM','2.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.25 PM','3.05 PM'),
                        SizedBox(height: 15.0,),
