...
class TrincomaleeVavuniya extends StatefulWidget {
  @override
  _TrincomaleeVavuniyaState createState() => _TrincomaleeVavuniyaState();
}

class _TrincomaleeVavuniyaState extends State<TrincomaleeVavuniya> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','10.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.45 AM','10.45 AM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('2.15 PM','4.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
