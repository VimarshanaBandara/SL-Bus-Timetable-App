...
class AnamaduwaColombo extends StatefulWidget {
  @override
  _AnamaduwaColomboState createState() => _AnamaduwaColomboState();
}

class _AnamaduwaColomboState extends State<AnamaduwaColombo> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Anamaduwa',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                        Icon(Icons.arrow_right_alt_outlined,size: 45.0,color: Colors.white,),
                        Text('Colombo(AC)',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('ආණමඩුව',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('129 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('03.20 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.15 AM','6.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 AM','8.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 PM','9.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.45 PM','10.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 PM','11.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.45 AM','12.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.45 AM','1.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.45 AM','2.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.45 PM','5.05 PM'),
                        SizedBox(height: 15.0,),
