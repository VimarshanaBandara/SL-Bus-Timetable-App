...
class NegamboKalpitiya extends StatefulWidget {
  @override
  _NegamboKalpitiyaState createState() => _NegamboKalpitiyaState();
}

class _NegamboKalpitiyaState extends State<NegamboKalpitiya> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('133.3 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
