...
class ColomboMutur extends StatefulWidget {
  @override
  _ColomboMuturState createState() => _ColomboMuturState();
}

class _ColomboMuturState extends State<ColomboMutur> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Mutur',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('මුතුර්',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('270.9 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('06.30 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('6.20 AM','12.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','4.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','9.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.20 PM','12.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.05 PM','3.35 AM'),
                        SizedBox(height: 15.0,),
