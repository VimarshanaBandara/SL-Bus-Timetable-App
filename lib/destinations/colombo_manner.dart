...
class ColomboMannar extends StatefulWidget {
  @override
  _ColomboMannarState createState() => _ColomboMannarState();
}

class _ColomboMannarState extends State<ColomboMannar> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('1.25 AM','9.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.40 AM','2.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','4.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.25 AM','5.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.05 AM','6.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.10 AM','7.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.50 AM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.20 PM','9.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','12.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.20 PM','3..20 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.40 PM','4.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 PM','6.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('11.20 PM','7.20 AM'),
                        SizedBox(height: 15.0,),
