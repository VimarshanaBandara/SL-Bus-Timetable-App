...
class MataraEmbilipitiya extends StatefulWidget {
  @override
  _MataraEmbilipitiyaState createState() => _MataraEmbilipitiyaState();
}

class _MataraEmbilipitiyaState extends State<MataraEmbilipitiya> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('4.40 PM','6.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 PM','7.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.25 PM','7.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.50 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 PM','8.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.45 PM','8.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 PM','9.15 PM'),
                        SizedBox(height: 15.0,),
