...
class TrincomaleeKurunegala extends StatefulWidget {
  @override
  _TrincomaleeKurunegalaState createState() => _TrincomaleeKurunegalaState();
}

class _TrincomaleeKurunegalaState extends State<TrincomaleeKurunegala> {
  @override
