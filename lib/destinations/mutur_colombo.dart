...
class MuturColombo extends StatefulWidget {
  @override
  _MuturColomboState createState() => _MuturColomboState();
}

class _MuturColomboState extends State<MuturColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.30 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 AM','11.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 AM','3.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.40 PM','3.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('10.40 PM','5.10 AM'),
                        SizedBox(height: 15.0,),
