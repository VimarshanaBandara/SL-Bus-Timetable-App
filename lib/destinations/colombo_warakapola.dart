...
class ColomboWarakapola extends StatefulWidget {
  @override
  _ColomboWarakapolaState createState() => _ColomboWarakapolaState();
}

class _ColomboWarakapolaState extends State<ColomboWarakapola> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Warakapola',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('වරකාපොළ',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('62.9 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.10 PM','5.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.50 PM','6.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.15 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
