...
class ColomboDigana extends StatefulWidget {
  @override
  _ColomboDiganaState createState() => _ColomboDiganaState();
}

class _ColomboDiganaState extends State<ColomboDigana> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Digana',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('දිගන',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('139 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.35 PM','7.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.25 PM','8.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.05 PM','9.05 PM'),
                        SizedBox(height: 15.0,),
