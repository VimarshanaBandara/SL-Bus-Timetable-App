...
class MataraPanadura extends StatefulWidget {
  @override
  _MataraPanaduraState createState() => _MataraPanaduraState();
}

class _MataraPanaduraState extends State<MataraPanadura> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('6.20 AM','8.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.10 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','9.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.50 AM','10.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.40 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','3.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','4.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 PM','5.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 PM','6.20 PM'),
                        SizedBox(height: 15.0,),
