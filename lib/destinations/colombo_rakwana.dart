...
class ColomboRakwana extends StatefulWidget {
  @override
  _ColomboRakwanaState createState() => _ColomboRakwanaState();
}

class _ColomboRakwanaState extends State<ColomboRakwana> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Rakwana',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('රක්වාන',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('132.6 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('1.55 PM','4.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.40 PM','6.40 PM'),
                        SizedBox(height: 15.0,),
