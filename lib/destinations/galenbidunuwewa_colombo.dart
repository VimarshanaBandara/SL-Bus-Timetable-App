...
class GalenbidunuwewaColombo extends StatefulWidget {
  @override
  _GalenbidunuwewaColomboState createState() => _GalenbidunuwewaColomboState();
}

class _GalenbidunuwewaColomboState extends State<GalenbidunuwewaColombo> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('ගලෙන්බිදුනුවැව',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),),
