...
class JaffnaColombo extends StatefulWidget {
  @override
  _JaffnaColomboState createState() => _JaffnaColomboState();
}

class _JaffnaColomboState extends State<JaffnaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('6.15 AM','4.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','5.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.50 AM','10.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.30 PM','7.45 AM'),
                        SizedBox(height: 15.0,),
