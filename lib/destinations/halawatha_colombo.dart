...
class HalawathaColombo extends StatefulWidget {
  @override
  _HalawathaColomboState createState() => _HalawathaColomboState();
}

class _HalawathaColomboState extends State<HalawathaColombo> {
  @override
