...
class KurunegalaTrincomalee extends StatefulWidget {
  @override
  _KurunegalaTrincomaleeState createState() => _KurunegalaTrincomaleeState();
}

class _KurunegalaTrincomaleeState extends State<KurunegalaTrincomalee> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('162.6 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('3.30 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
