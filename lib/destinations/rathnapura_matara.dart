...
class RathnapuraMatara extends StatefulWidget {
  @override
  _RathnapuraMataraState createState() => _RathnapuraMataraState();
}

class _RathnapuraMataraState extends State<RathnapuraMatara> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('157.2 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
