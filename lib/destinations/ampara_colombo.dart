...
class AmparaColombo extends StatefulWidget {
  @override
  _AmparaColomboState createState() => _AmparaColomboState();
}

class _AmparaColomboState extends State<AmparaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('6.45 AM','1.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','2.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','3.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','4.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.45 AM','4.45 AM'),
                        SizedBox(height: 15.0,),
