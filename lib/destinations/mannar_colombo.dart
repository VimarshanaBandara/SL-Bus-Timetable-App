...
class MannarColombo extends StatefulWidget {
  @override
  _MannarColomboState createState() => _MannarColomboState();
}

class _MannarColomboState extends State<MannarColombo> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Mannar',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),),
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('මන්නාරම',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('312 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('08.00 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('3.30 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 AM','3.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','4.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.30 AM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','7.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.25 PM','9.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.05 PM','1.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.05 PM','3.05 AM'),
                        SizedBox(height: 15.0,),
