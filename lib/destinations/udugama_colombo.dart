...
class UdugamaColombo extends StatefulWidget {
  @override
  _UdugamaColomboState createState() => _UdugamaColomboState();
}

class _UdugamaColomboState extends State<UdugamaColombo> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.30 AM','6.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','7.45 AM'),
                        SizedBox(height: 15.0,),
