...
class ColomboKuliyapitiya extends StatefulWidget {
  @override
  _ColomboKuliyapitiyaState createState() => _ColomboKuliyapitiyaState();
}

class _ColomboKuliyapitiyaState extends State<ColomboKuliyapitiya> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('6.30 AM','8.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.15 AM','9.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','9.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','10.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','11.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.15 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.55 AM','11.55 AM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('3.50 PM','5.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 PM','6.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.20 PM','6.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 PM','7.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 PM','7.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.40 PM','7.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.50 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.10 PM','8.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.20 PM','8.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 PM','8.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 PM','9.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 PM','9.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 PM','10.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 PM','10.30 PM'),
                        SizedBox(height: 15.0,),
