...
class KaduruwelaMahiyanganaya extends StatefulWidget {
  @override
  _KaduruwelaMahiyanganayaState createState() => _KaduruwelaMahiyanganayaState();
}

class _KaduruwelaMahiyanganayaState extends State<KaduruwelaMahiyanganaya> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('6.40 AM','9.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','10.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.05 AM','11.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.35 AM','12.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.05 AM','12.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.40 AM','1.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.20 AM','2.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.40 PM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.30 PM','4.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','4.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','5.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.50 PM','7.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.25 PM','6.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.40 PM','6.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 PM','7.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.30 PM','7.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 PM','7.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.00 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 PM','10.20 PM'),
                        SizedBox(height: 15.0,),
