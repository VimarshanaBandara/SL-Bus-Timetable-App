...
class GalnewaColombo extends StatefulWidget {
  @override
  _GalnewaColomboState createState() => _GalnewaColomboState();
}

class _GalnewaColomboState extends State<GalnewaColombo> {
  @override
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        Text('ගල්නෑව',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('2.40 AM','7.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.10 AM','7.40 AM'),
                        SizedBox(height: 15.0,),
