...
class TrincomaleeJaffna extends StatefulWidget {
  @override
  _TrincomaleeJaffnaState createState() => _TrincomaleeJaffnaState();
}

class _TrincomaleeJaffnaState extends State<TrincomaleeJaffna> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('1.30 AM','5.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.30 AM','7.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.15 AM','8.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('11.30 AM','3.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.45 PM','4.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.45 PM','6.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.15 PM','7.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.45 PM','7.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 PM','8.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 PM','10.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 PM','12.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('11.00 PM','3.00 AM'),
                        SizedBox(height: 15.0,),
