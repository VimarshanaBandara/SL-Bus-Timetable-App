...
class AnuradhapuraPanadura extends StatefulWidget {
  @override
  _AnuradhapuraPanaduraState createState() => _AnuradhapuraPanaduraState();
}

class _AnuradhapuraPanaduraState extends State<AnuradhapuraPanadura> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('224.6 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
