...
class ColomboDeniyaya extends StatefulWidget {
  @override
  _ColomboDeniyayaState createState() => _ColomboDeniyayaState();
}

class _ColomboDeniyayaState extends State<ColomboDeniyaya> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Deniyaya',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('දෙනියාය',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('207.00 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('7.10 PM','10.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.50 PM','2.20 PM'),
                        SizedBox(height: 15.0,),
