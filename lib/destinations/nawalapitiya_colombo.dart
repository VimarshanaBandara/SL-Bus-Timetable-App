...
class NawalapitiyaColombo extends StatefulWidget {
  @override
  _NawalapitiyaColomboState createState() => _NawalapitiyaColomboState();
}

class _NawalapitiyaColomboState extends State<NawalapitiyaColombo> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('144.00 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('6.25 AM','11.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','2.30 PM'),
                        SizedBox(height: 15.0,),
