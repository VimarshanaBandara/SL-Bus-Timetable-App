...
class ColomboBibila extends StatefulWidget {
  @override
  _ColomboBibilaState createState() => _ColomboBibilaState();
}

class _ColomboBibilaState extends State<ColomboBibila> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Bibila',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('235.6 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('06.10 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('6.00 AM','12.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.00 AM','4.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.45 PM','10.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 PM','12.15 AM'),
                        SizedBox(height: 15.0,),
