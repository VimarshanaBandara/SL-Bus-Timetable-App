...
class ColomboNuwaraeliya extends StatefulWidget {
  @override
  _ColomboNuwaraeliyaState createState() => _ColomboNuwaraeliyaState();
}

class _ColomboNuwaraeliyaState extends State<ColomboNuwaraeliya> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Nuwara-Eliya',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('නුවරඑළිය',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('180 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('3.00 AM','8.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.45 AM','9.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.25 AM','10.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','12.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.45 AM','12.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.20 AM','1.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.10 AM','3.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.20 PM','7.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.05 AM','8.05 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 PM','11.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','12.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.00 AM','1.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.00 AM','2.00 AM'),
                        SizedBox(height: 15.0,),
