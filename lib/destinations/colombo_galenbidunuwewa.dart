...
class ColomboGalenbidunuwewa extends StatefulWidget {
  @override
  _ColomboGalenbidunuwewaState createState() => _ColomboGalenbidunuwewaState();
}

class _ColomboGalenbidunuwewaState extends State<ColomboGalenbidunuwewa> {
  @override
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        Text('Galenbidunuwewa',style: TextStyle(color: Colors.white,fontSize: 27.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        ...
                        Text('ගලෙන්බිදිනුවැව',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('216.4 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                          Text('4.30 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('5.05 PM','9.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.50 PM','2.20 AM'),
                        SizedBox(height: 15.0,),
