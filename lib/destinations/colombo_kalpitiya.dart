...
class ColomboKalpitiya extends StatefulWidget {
  @override
  _ColomboKalpitiyaState createState() => _ColomboKalpitiyaState();
}

class _ColomboKalpitiyaState extends State<ColomboKalpitiya> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text('168.1 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
