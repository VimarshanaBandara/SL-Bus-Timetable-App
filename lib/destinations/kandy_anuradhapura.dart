...
class KandyAnuradhapura extends StatefulWidget {
  @override
  _KandyAnuradhapuraState createState() => _KandyAnuradhapuraState();
}

class _KandyAnuradhapuraState extends State<KandyAnuradhapura> {
  @override
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        Text('අනුරාධපුර',style: TextStyle(color: Colors.white,fontSize: 17.0,fontWeight: FontWeight.bold),)
                      ],
                    ),
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('3.00 Hours',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),)
                        ],
                      ),
                    )
                  ],
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        Template('4.55 AM','7.55 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 AM','8.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.45 AM','8.45 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.10 AM','9.10 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.35 AM','9.35 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.00 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.25 AM','10.25 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.50 AM','10.50 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.15 AM','11.15 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.40 AM','11.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.05 AM','12.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.30 AM','12.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('9.55 AM','12.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.20 AM','1.20 PM'),
                        SizedBox(height: 15.0,),
                        Template('10.45 AM','1.45 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.10 AM','2.10 PM'),
                        SizedBox(height: 15.0,),
                        Template('11.35 AM','2.35 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.00 PM','3.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.25 PM','3.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.50 PM','3.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.15 PM','4.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 PM','4.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.05 PM','5.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.30 PM','5.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.55 PM','5.55 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.20 PM','6.20 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('5.25 PM','8.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('5.50 PM','8.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.15 PM','9.15 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.50 PM','9.50 PM'),
                        SizedBox(height: 15.0,),
