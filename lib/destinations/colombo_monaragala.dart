...
class ColomboMonaragala extends StatefulWidget {
  @override
  _ColomboMonaragalaState createState() => _ColomboMonaragalaState();
}

class _ColomboMonaragalaState extends State<ColomboMonaragala> {
  @override
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('12.40 AM','6.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('1.40 AM','7.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('2.40 AM','8.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('3.00 AM','9.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('4.00 AM','10.00 AM'),
                        SizedBox(height: 15.0,),
                        Template('5.30 AM','11.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.00 AM','12.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('6.30 AM','12.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 AM','1.30 PM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 AM','2.30 PM'),
                        SizedBox(height: 15.0,),
                        ...
                        SizedBox(height: 15.0,),
                        Template('12.05 PM','6.05 PM'),
                        SizedBox(height: 15.0,),
                        Template('12.40 PM','6.40 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.00 PM','7.00 PM'),
                        SizedBox(height: 15.0,),
                        Template('1.50 PM','7.50 PM'),
                        SizedBox(height: 15.0,),
                        Template('2.25 PM','8.25 PM'),
                        SizedBox(height: 15.0,),
                        Template('3.35 PM','9.35 PM'),
                        SizedBox(height: 15.0,),
