...
class ColomboAmpara extends StatefulWidget {
  @override
  _ColomboAmparaState createState() => _ColomboAmparaState();
}

class _ColomboAmparaState extends State<ColomboAmpara> {
  @override
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text( '359.7 KM',style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: 23.0),),
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                        ...
                        Template('4.20 PM','11.20 pM'),
                        SizedBox(height: 15.0,),
                        Template('5.20 PM','12.20 AM'),
                        SizedBox(height: 15.0,),
                        Template('6.40 PM','1.40 AM'),
                        SizedBox(height: 15.0,),
                        Template('7.30 PM','2.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('8.30 PM','3.30 AM'),
                        SizedBox(height: 15.0,),
                        Template('9.45 PM','4.45 AM'),
                        SizedBox(height: 15.0,),
